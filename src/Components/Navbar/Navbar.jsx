              ...
              <div className="flex h-16 items-center">
                ...
                <div className="ml-auto flex items-center">
                  <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                    ...
                    <a className="text-sm font-medium text-gray-700 cursor-pointer  " onClick={handleLogout} style={{ color: mode === 'dark' ? 'white' : '', }}>
                      Logout
                    </a>
                  </div>
                  ...
                  <div className="hidden lg:ml-8 lg:flex">
                    <a href="#" className="flex items-center text-gray-700 ">
                      <img
                        className="inline-block w-10 h-10 rounded-full"
                        src="https://lh3.googleusercontent.com/a/ACg8ocJ0uVq0weZxBnDdenKlJQKLk1dT8oMKIG3UVMnjyoBWBZg=s324-c-no"
                        alt="Dan_Abromov" />
                    </a>
                  </div>
